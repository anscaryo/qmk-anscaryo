...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_QWERTY] = LAYOUT_split_3x6_3(
                                                                 ...
                                                                 //                                    |--------------------------|  |--------------------------|*/
                                                                  KC_TAB, ES_Q, ES_W, ES_E, ES_R, ES_T, ES_Y, ES_U, ES_I, ES_O, ES_P, KC_BSPC, BT_CAPS, ES_A, ES_S, ES_D, ES_F, ES_G, ES_H, ES_J, ES_K, ES_L, ES_NTIL, ES_ACUT, KC_LCTL, ES_Z, ES_X, ES_C, ES_V, ES_B, ES_N, ES_M, ES_COMM, ES_DOT, ES_MINS, KC_SFTENT, KC_LGUI, MO(1), KC_SPC, KC_SPC, MO(2), KC_RALT),
                                                              ...
                                                              [_LOWER] = LAYOUT_split_3x6_3(
                                                                  ...
                                                                  */
                                                                  ...
                                                                  KC_GESC, ES_1, ES_2, ES_3, ES_4, ES_5, ES_6, ES_7, ES_8, ES_9, ES_0, KC_DEL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, ES_CIRC, ES_ASTR, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, ES_LCBR, ES_LBRC, ES_RBRC, ES_RCBR, ES_BSLS, XXXXXXX, KC_LGUI, _______, KC_SPC, KC_ENT, MO(3), KC_RALT),
                                                              ...
                                                              [_RAISE] = LAYOUT_split_3x6_3(
                                                                  ...
                                                                  ES_MORD, ES_EXLM, ES_DQUO, ES_BULT, ES_DLR, ES_PERC, ES_AMPR, ES_SLSH, ES_LPRN, ES_RPRN, ES_EQL, KC_DEL, _______, _______, _______, _______, KC_VOLU, _______, _______, _______, _______, _______, ES_PIPE, ES_ACUT, KC_RCTL, ES_RABK, _______, _______, KC_VOLD, KC_MUTE, ES_CCED, ES_PLUS, ES_SLSH, ES_IQUE, ES_QUES, ES_FORD, KC_LALT, MO(3), KC_SPC, KC_ENT, _______, KC_RALT),
                                                              ...
                                                              [_ADJUST] = LAYOUT_split_3x6_3(
                                                                  ...
                                                                  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_POWER, XXXXXXX, RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX, RGB_MOD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX, RGB_RMOD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MO(4), KC_TRNS, KC_SPC, KC_SPC, KC_TRNS, KC_RALT)};
