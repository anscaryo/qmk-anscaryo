...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_split_3x6_3(
		/*
		//|-----------------------------------------------------|                  |-----------------------------------------------------|
			TAB,       Q,      	W,        E,      R,      T,                           Y,      U,       I,       O,    (CNTR+V)P,  BSPC,
		*/
		...
		*/
		...
		/*//---------+--------+--------+--------+--------+--------|                |--------+--------+--------+--------+--------+--------|
			CNTRL,     Z,       X,    (Ctr+C)C,      V,      B,                         N,      M,        ,   ,   . ,      -,     ENTER,
		*/
		KC_LCTL, KC_Z, KC_X, TD(TD_COPY), TD(TD_PASTE), KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_ENT),
		/*//---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
		 */
		WIN, LOWER, SPC, SPC, RAISE, ALT KC_LGUI, MO(1), KC_SPC, KC_SPC, MO(2), KC_RALT
																						/*
																						//                                      |--------------------------|  |--------------------------|
																						*/
	...
	[_RAISE] = LAYOUT_split_3x6_3(
		...
		//|-----------------------------------------------------|                    |-----------------------------------------------------|
			  *,       !,        @,       #,       $,       %,                             ^,       &,      *,       (,       ),     BSPC,
		//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
		   _______, _______, _______ _______, _______, _______,                         -/_,     =/+,     [/{,     ]/},       |,     SUPR,
		//---------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
		   _______, _______, _______, _______, _______, _______,                          _,       +,       {,      },       \,     ENTER,
		//---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
																																						WIN,    LOWER,     SPC,        SPC,     RAISE, R_ALT
		//									  |--------------------------|  |--------------------------|
		...
		*/
		...
		//|--------+--------+--------+--------+--------+--------| 		  			 |--------+--------+--------+--------+--------+--------|
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLD, KC_MUTE, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
		//---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
	...
	[_NUMERICO] = LAYOUT_split_3x6_3(
		/*
		//|-----------------------------------------------------|                    |-----------------------------------------------------|
			NUMLOCK, _______, _______, _______, _______, _______,                      AV_PAG ,    7   ,    8   ,    9   ,    *   ,    /   ,
		//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
			_______, _______, _______, _______, _______, _______,                       RE_PAG,    4   ,    5   ,    6   ,    +   ,    -   ,
		//---------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
			_______, _______, _______, _______, _______, _______,					      					0   ,    1   ,    2   ,    3   ,    .   ,    =   ,
		//---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
																						_______, _______,  HOME,        END,   _______, _______,
		//									                  |--------------------------|  |--------------------------|
		*/

		//|-----------------------------------------------------|                    |-----------------------------------------------------|
		KC_NUMLOCK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, KC_P7, KC_P8, KC_P9, KC_PAST, KC_PSLS,
		//|--------+--------+--------+--------+--------+--------| 					 |--------+--------+--------+--------+--------+--------|
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGDN, KC_P4, KC_P5, KC_P6, KC_PPLS, KC_PMNS,
		//|--------+--------+--------+--------+--------+--------| 					 |--------+--------+--------+--------+--------+--------|
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_P0, KC_P1, KC_P2, KC_P3, KC_PDOT, KC_PEQL,
		//---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
		XXXXXXX, XXXXXXX, KC_HOME, KC_END, XXXXXXX, KC_BSPC
		//									  |--------------------------|  |--------------------------|
		)};
